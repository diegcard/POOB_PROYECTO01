...
public class Bridge{
     ...
     */
    public Bridge(float x1, float y1,float x2, float y2, int FistStrand, int Distance, String direction, String color){
        this.bridge = new Linea(x1,y1,x2,y2);
        this.identificador = new Circle((int)x1,(int)y1,5);
        identificador.relocate((int) (x1-identificador.getDiameter()/2),(int) (y1-identificador.getDiameter()/2));
    ...
    public void newPoints(float newx1, float newy1,float newx2, float newy2){
        ...
        identificador.relocate((int) (newx1-identificador.getDiameter()/2),(int) (newy1-identificador.getDiameter()/2));
    }
